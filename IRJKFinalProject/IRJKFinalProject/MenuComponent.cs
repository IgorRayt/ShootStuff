...
namespace IRJKFinalProject
{
    ...
    public class MenuComponent : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        //private Color titleFont = Color.LightBlue;
        private Color regularColor = Color.Blue;
        private Color hilightColor = Color.LightBlue;
            ...
            : base(game)
        {
            ...
            //myPosition = new Vector2(450, 400);
            //position = new Vector2(Shared.stage.X/2, Shared.stage.Y/2); // x or y/2
        }
